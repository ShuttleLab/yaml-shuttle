...
export const messages = {
  zh: {
    ...
    about: {
      ...
      support: {
        title: "支持我们",
        supportDesc: "YAML Shuttle 免费使用，由个人维护。若对您有帮助，欢迎通过以下方式支持。",
        supportBtn: "支持项目",
        shareBtn: "分享给朋友",
  ...
  en: {
    ...
    about: {
      ...
      support: {
        title: "Support Us",
        supportDesc: "YAML Shuttle is free and maintained by one person. If it helps you, consider supporting:",
